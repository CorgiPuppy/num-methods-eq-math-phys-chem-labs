...
Сравнить результаты расчётов заданий №1 и №2 друг с другом, а также с истинными значениями функции #emph([u]) в соответствующих точках разностной сетки: \

Результаты расчётов заданий №1 и №2 только при $#ptgk("D") t = 0.001$ сходятся, так как явная разностная схема устойчива только при $#ptgk("D") t lt.eq 0.005$.
